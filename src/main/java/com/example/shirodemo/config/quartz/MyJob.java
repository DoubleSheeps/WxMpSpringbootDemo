...
public class MyJob {
    ...
    protected void twoHoursClassTips() throws ParseException {
        try{
        Date now = DateStringUtil.getMinuteDate(new Date(System.currentTimeMillis()));
        ...
        courseService.courseTips(dateStart,dateEnd,"VS4UF_n9VxU61nCvJYWmEuz7HZ3PLE0TNLv6fUtjkAg");
            ...
            log.error("触发课前2小时提醒任务失败，日期格式转换错误。");
        }
    }
